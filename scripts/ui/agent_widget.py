...
from grande_alpha.research.agent_models import AgentSettings, AgentSnapshot, parse_symbols
...
class AgentWidget(QScrollArea):
    ...
    def _copy_mcp_config(self) -> None:
        config = {"mcpServers": {"grande-alpha": {
            ...
            "args": ["-m", "grande_alpha.research.agent_mcp", "--bridge", str(self.controller.agent_bridge.path.resolve())],
    ...
    def _set_controls(self) -> None:
        ...
        self.mcp_enabled.setEnabled(enabled or bool(self.controller.agent_bridge.session))
