...
from grande_alpha.data.earnings import LIMITS
from grande_alpha.domain.models import utc_now
from grande_alpha.execution.authorization import UserAuthorizationGate, create_authorization
...
def command_run_autonomous(args) -> int:
    ...
    from grande_alpha.interfaces.cli.live_cli import terminal_line
    from grande_alpha.persistence.store import AuditStore
