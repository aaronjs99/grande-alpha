"""Shared plain-language product terminology, independent of the desktop toolkit."""
...
TERM_HELP: dict[str, str] = {
    ...
    "Selected runtime policy": (
        "The signal policy used by historical runtime replay. CASH / hold is the fail-safe "
