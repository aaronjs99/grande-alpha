...
The sandbox exposes the same fields. Evidence-policy version 7 binds them into the strategy
fingerprint and adds a complete-session-coverage gate. Regular data cannot certify an extended or
