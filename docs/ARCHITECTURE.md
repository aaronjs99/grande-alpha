...
| Domain records and policy | `domain/market_models.py`, `domain/account_models.py`, `domain/order_models.py`, `domain/authorization_models.py`, `domain/crypto_models.py`, `domain/policy.py` | Market observations, account snapshots, order records, shared exchange-time rules, and authority records have separate validation boundaries |
| Market and earnings inputs | `data/live_data.py`, `data/earnings_feed.py`, `data/dataset_manifest.py`, `data/csv_inspection.py`, `research/historical_models.py`, `research/historical.py`, `research/historical_source.py`, `research/historical_storage.py`, `domain/market_calendar.py` | Shared history records and provenance are separate from transformations, provider acquisition, file storage, and fresh broker observations |
| Strategy and replay | `strategy/`, `data/earnings.py`, `research/sandbox_models.py`, `research/sandbox_execution.py`, `research/bar_replay.py`, `research/runtime_replay.py`, `research/runtime_trace.py`, `research/runtime_trace_provenance.py`, `research/evidence_contract.py`, `research/evidence_search.py`, `research/evidence_promotion.py`, `research/evidence_replay.py`, `research/evidence_statistics.py` | Replay coordination, virtual fills, source provenance, experiment search, and qualification are separate; research results do not authorize orders |
...
| Persistence | `persistence/`, `persistence/execution_authority.py`, `persistence/execution_orders.py`, `persistence/execution_risk.py`, `persistence/research_fund.py`, `persistence/research_holdouts.py`, `persistence/research_evidence.py`, `execution/authorization.py` | Focused records share one SQLite transaction manager where authorization, orders, fills, and daily risk must remain consistent |
